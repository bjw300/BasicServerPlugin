...
public class WarpEditGui {
    ...
    public void openWarpEdit(Player player, String warp) { //open warp edit gui (gui)
        inv = Bukkit.createInventory(null, 27, "'" + warp + "' warp edit menu");
        item = new ItemStack(Material.GRASS);meta = item.getItemMeta();meta.setDisplayName("Re-name");meta.setLore(Arrays.asList("this will be added soon"));item.setItemMeta(meta);
        item2 = new ItemStack(Material.GRASS);meta2 = item2.getItemMeta();meta2.setDisplayName("Re-set the logo");meta2.setLore(Arrays.asList("this will be added soon"));item2.setItemMeta(meta2);
        ...
        item4 = new ItemStack(Material.REDSTONE_BLOCK);meta4 = item4.getItemMeta();meta4.setDisplayName("Delete");meta4.setLore(Arrays.asList("delete this warp point"));item4.setItemMeta(meta4);
